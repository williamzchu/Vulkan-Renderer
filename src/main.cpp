...
private:
	...
	std::vector<vk::raii::CommandBuffer> commandBuffers; // One command buffer for each frame in flight

	uint32_t currentFrame = 0; // Current frame in flight
	uint32_t semaphoreIndex = 0; // Current semaphore index of the swapchain images

	// One sync object for each frame in flight
